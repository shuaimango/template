...
public class GlideCircleBorderTransform extends BitmapTransformation {
    ...
    private static final String ID = "jp.wasabeef.glide.transformations. " + VERSION;
    ...
    public GlideCircleBorderTransform(int radius, String color, int border) {
        this( radius, 0, CornerType.BORDER);
        mColor = color;
        mBorder = border;
    }
    public GlideCircleBorderTransform(int radius, int margin) {
        this(radius, margin,  CornerType.ALL);
    }

    public GlideCircleBorderTransform(int radius, int margin, CornerType cornerType) {
        this.radius = radius;
    ...
    private void drawBorder(Canvas canvas, Paint paint, float right,
        ...
        canvas.drawRoundRect(new RectF(mBorder, mBorder, right, bottom), radius, radius, paint);

        // stroke
        canvas.drawRoundRect(new RectF(mBorder , mBorder, right, bottom), radius, radius, strokePaint);
    }
    @Override
    ...
    public boolean equals(Object o) {
        return o instanceof  GlideCircleBorderTransform &&
                (( GlideCircleBorderTransform) o).radius == radius &&
                (( GlideCircleBorderTransform) o).diameter == diameter &&
                (( GlideCircleBorderTransform) o).margin == margin &&
                (( GlideCircleBorderTransform) o).cornerType == cornerType;
    }
